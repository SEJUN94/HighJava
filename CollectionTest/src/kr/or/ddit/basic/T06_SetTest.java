...
public class T06_SetTest {
	public static void main(String[] args) {
		...
		// => headSet(기준값, 논리값) : 논이값이 true이면 '기준값'포함
		SortedSet<String> ss1 = ts.headSet("K");  //  <------여기서는 기준값"K" headSet(" ")은 " "보다 작은것 
		System.out.println("K이전 자료 : " + ss1);  // 기준값 미포함
		System.out.println("K이전 자료(기준값 포함): "
				+ ts.headSet("K", true));
		...
		System.out.println("K이후 자료(기준값 미포함) : "
				+ ts.tailSet("K", false));
