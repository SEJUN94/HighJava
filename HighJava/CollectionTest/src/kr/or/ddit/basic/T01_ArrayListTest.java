...
public class T01_ArrayListTest {
	public static void main(String[] args) {
		...
		list1.remove("bbb");
//		list1.remove(1111); error뜸
		list1.remove(new Integer(1111));
		...
		for (int i = 0; i < list2.size(); i++) {  // index가 필요할때 forech문(향상된 for문)보다 for문을 선호
		...
		Object[] strArr = list2.toArray();  // toArray 배열타입으로 형변환 시켜줌 
