...
/*
	...
	파라미터 타입과 리턴타입으로 타입글자(타입파라미터)를 가지는 메서드
...
//		boolean result2 = Util.<String, String>compare(p3, p4);
		boolean result2 = Util.compare(p3, p4); // 컴파일러가 자동으로 <String, String>을 넣어줌
...
//		p1.<String, Integer>display("키", 180);
		p1.display("키", 180); // 위와 동일 컴파일러가 <String, String>을 자동적으로 넣어줌
	}
}
