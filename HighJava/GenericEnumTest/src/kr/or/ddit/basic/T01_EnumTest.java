 ...
 */
	...
	/*
	 	...
	 	데이터 값을 정해 줄 경우에는 생생자를 만들어서 괄호속의 값이
	 	변수에 저장되도록 해야 한다.
	 */
	public enum Season {
		...
		/*
			...
			2. ordinal() => 열거형 상수가 정의된 순서값을 반환한다.
							(기본적으로 0부터 시작)
			3. valueOf("열거형상수이름") => 지정된 열거형에서 
				'열거형상수이름'과 일치하는 열거형 상수를 반환한다.
		 */
...
//			System.out.println(Korea.대전 == City.대전); // City와 Korea의 타입이 맞지 않기때문에 비교를 할수없다 enum을 사용하면 미연에 실수를 방지할수있게 해준다.
