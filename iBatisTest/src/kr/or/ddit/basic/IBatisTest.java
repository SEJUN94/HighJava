...
public class IBatisTest {
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 실행할 SQL문에 맞는 쿼리문을 호출해서 원하는 작업응 수행한다.
			// 2-1. insert작업 연습
			...
			// 형식) smc.insert("namespace값.id값", 파라미터클래스);  파라미터클래스 : 내가 쿼리를 실행할때 객체에 던져준 타입을 알려줌
			// 반환값 : 성공하면 null이 반환된다.
			/*
			...
			*/
			...
			/*
				응답 결과가 여러개 일 경우에 queryForList메서드를 사용한다.
			...
			*/
			...
			// 응답결과가 1개가 확실할 경우에는 queryForObject메서드를 이용한다.
