...
// Thread Stop은  Runnable(진행중)인 스레드를 정지시키는것 
public class T13_ThreadStopTest {
/*
	Thread stop()메서드를 호출하면 스레드가 바로 멈춘다.
...
class ThreadStopEx2 extends Thread {
	...
	public void run() {
		...
		//         interrupt()메서드를 호출하면 InterruptException
		//         이 발생한다.
		try {
			while(true) {
