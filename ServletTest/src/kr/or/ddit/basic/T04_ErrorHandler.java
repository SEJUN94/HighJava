...
public class T04_ErrorHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (throwable == null && statusCode == null) {
			...
			out.println("<h2>예외/에러 정보</h2>" + "상태코드 : " + statusCode + "<br><br>" + "에러메시지 : " + message + "<br><br>"
					+ "서블릿 이름 : " + servletName + "<br><br>" + "요청 URI : " + reqUri + "<br><br>");
			if (statusCode != null) {
				out.println(
						"예외타입: " + throwable.getClass().getName() + "<br><br>" + "예외 메시지 : " + throwable.getMessage());
			}
		}
